function excuate() {
    ...
    var User = require('./gen-nodejs/User_types');
    ...
    // Create a User client with the connection
    var client = thrift.createClient(User, connection);
